...
Die Projektdateien für das Kapitel 05 vom Buch **Zend Framework 2 - Von den 
...
* Sie können die Projektdateien als ZIP von der Website http://www.awl.de/2994 
  unter Downloads oder von GitHub https://github.com/ZF2Buch/kapitel05 herunter
  laden und in einem geeigneten Verzeichnis entpacken, z.B.
```
  /home/devhost/zf2buch/kapitel05
```
...
```
    ...
    $ git clone https://github.com/ZF2Buch/kapitel05.git
    $ cd kapitel05/
```
...
```
    <VirtualHost *>
      ...
      DocumentRoot /home/devhost/zf2buch/kapitel05/public/
      AccessFileName .htaccess
      <Directory /home/devhost/zf2buch/kapitel05/public/>
